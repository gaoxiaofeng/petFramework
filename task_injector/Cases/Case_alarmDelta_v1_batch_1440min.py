...
class Case(_RestdaCase):
    ...
    def action(self):
        ...
        json = json_template.substitute(duration='1440', startTime=self.the_day_before(seconds=30),
                                        endTime=self.the_day_after(days=8), cronExpression="RESTDA_CRON 0 0 6 * * ?")
